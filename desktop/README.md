# TCG Business Manager – Analysecenter 6.0.0
...
- Lokaler iPhone-Fotoscanner per zeitlich begrenztem QR-Code; jede Druckvariante muss vor dem Speichern bestätigt werden.
