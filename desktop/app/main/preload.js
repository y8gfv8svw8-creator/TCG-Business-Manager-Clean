...
contextBridge.exposeInMainWorld('desktopApp', Object.freeze({
  ...
  findPrintCandidates: payload => ipcRenderer.invoke('print-reference:find-candidates', payload),
  resolveCollectionPrintRecognition: payload => ipcRenderer.invoke('print-reference:resolve-collection-recognition', payload),
