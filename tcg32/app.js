...
const defaultState = {
  ...
  sales: [],
  watchlist: [
    {id: crypto.randomUUID(), priority:"A", name:"Aschenblüte & Freudiger Frühling", set:"RA01", version:"V.3 – Secret Rare", stock:0, target:3, maxBuy:4.00, targetSell:5.99, ...WATCHLIST_REFERENCE["Aschenblüte & Freudiger Frühling"], reprint:"Mittel", banlist:"Niedrig", priceDate:"2026-07-16"},
    {id: crypto.randomUUID(), priority:"A", name:"Unendliche Unbeständigkeit", set:"RA01", version:"V.3 – Secret Rare", stock:0, target:3, maxBuy:4.00, targetSell:5.49, ...WATCHLIST_REFERENCE["Unendliche Unbeständigkeit"], reprint:"Mittel", banlist:"Niedrig", priceDate:"2026-07-16"},
    {id: crypto.randomUUID(), priority:"A", name:"Nibiru, das Urwesen", set:"RA01", version:"V.3 – Secret Rare", stock:0, target:3, maxBuy:2.00, targetSell:3.49, ...WATCHLIST_REFERENCE["Nibiru, das Urwesen"], reprint:"Mittel", banlist:"Niedrig", priceDate:"2026-07-16"},
    {id: crypto.randomUUID(), priority:"A", name:"Effektverschleierin", set:"RA01", version:"V.3 – Secret Rare", stock:0, target:3, maxBuy:2.75, targetSell:4.29, ...WATCHLIST_REFERENCE["Effektverschleierin"], reprint:"Mittel", banlist:"Niedrig", priceDate:"2026-07-16"},
    {id: crypto.randomUUID(), priority:"B", name:"Ausgeglichener Zweikampf", set:"RA01", version:"V.3 – Secret Rare", stock:0, target:3, maxBuy:2.25, targetSell:3.49, ...WATCHLIST_REFERENCE["Ausgeglichener Zweikampf"], reprint:"Mittel", banlist:"Niedrig", priceDate:"2026-07-16"}
  ],
  sellers: [],
  customers: [],
  imports: [],
...
function saveState() {
  ...
  el.textContent = "Lokal gespeichert";
  clearTimeout(saveState.t);
  saveState.t = setTimeout(() => el.textContent = "Bereit", 1200);
}
